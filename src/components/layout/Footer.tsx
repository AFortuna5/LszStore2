      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a href="https://instagram.com/lsz.storee" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-dark-blue flex items-center justify-center text-silver hover:text-white hover:bg-neon-blue transition-all">
                <InstagramIcon size={18} />
              </a>
              <a href="#" className="w-10 h-10 rounded-full bg-dark-blue flex items-center justify-center text-silver hover:text-white hover:bg-neon-blue transition-all">
            ...
            <ul className="flex flex-col gap-4 font-inter text-sm text-silver">
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="#" className="hover:text-neon-blue transition-colors">(11) 99999-9999</a>
                </div>
              </li>
              <li className="flex items-start gap-3">
        ...
        <div className="pt-8 border-t border-border flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="h-6 w-10 bg-silver/20 rounded"></div>
            <div className="h-6 w-10 bg-silver/20 rounded"></div>
            <div className="h-6 w-10 bg-silver/20 rounded"></div>
            <div className="h-6 w-10 bg-silver/20 rounded"></div>
          </div>
